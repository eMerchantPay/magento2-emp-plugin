...
/**
 * Class DirectIpnTest
 * @covers \EMerchantPay\Genesis\Model\Ipn\Direct
 * @package EMerchantPay\Genesis\Test\Unit\Model\Ipn
 */

class DirectIpnTest extends \EMerchantPay\Genesis\Test\Unit\Model\Ipn\AbstractIpnTest
{
    ...
    protected function getDataHelperMock()
    {
        ...
        $this->dataHelperMock->expects(self::once())
            ...
            ->with(\EMerchantPay\Genesis\Model\Method\Direct::CODE)
            ->willReturn(
